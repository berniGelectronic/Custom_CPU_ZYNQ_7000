...
HD_PWD='D:/MSc_DSE/AUTUMN_TERM/Digital Design/Lab/Group project/CPU_Final/Mem_subsyst_ full_interg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mem_Subsys_Full_Interg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mem_Subsys_Full_Interg.tcl -notrace
