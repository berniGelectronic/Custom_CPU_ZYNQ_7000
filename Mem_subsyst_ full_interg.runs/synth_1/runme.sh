...
HD_PWD='D:/MSc_DSE/AUTUMN_TERM/Digital Design/Lab/Group project/CPU_Final/Mem_subsyst_ full_interg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mem_Subsys_Full_Interg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mem_Subsys_Full_Interg.tcl
